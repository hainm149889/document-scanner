...
/**
 * Represents the JavaScript object/struct "DocumentCorners".
 */
@DoNotStrip
@Keep
data class DocumentCorners(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is DocumentCorners) return false
  ...
  companion object {
    ...
    @Suppress("unused")
    @JvmStatic
    private fun fromCpp(topLeft: Point, topRight: Point, bottomLeft: Point, bottomRight: Point): DocumentCorners {
      return DocumentCorners(topLeft, topRight, bottomLeft, bottomRight)
    }
  }
}
